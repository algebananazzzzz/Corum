...
| Dimension | Value | | --- | --- | | Mechanism | {{MECHANISM}} | | When | {{WHEN}} | | Gotcha | {{GOTCHA}} |

> [!example] > {{WORKED_EXAMPLE}}

> [!tool] > `{{COMMAND}}` — {{WHAT_TO_OBSERVE}}

## {{WIRE_OR_DATA_PART}}
%% {{SOURCE_LABEL}} p{{RANGE}} %%

| Field | Width | Value | | --- | --- | --- | | {{FIELD}} | {{WIDTH}} | {{VALUE}} |

> [!warning] > {{ANSWER_CHANGING_MISTAKE}}

> [!research] > {{RESEARCH_SOURCE}}. {{NECESSARY_GAP_FILLED}}

---

## Sources

| Source | Role | | --- | --- | | [[courses/{{COURSE}}/raw/{{SOURCE_PATH}}]] | Course completeness baseline | | [{{BACKBONE_TITLE}}]({{BACKBONE_SOURCE_URL}}) | Structure and framing | | {{PRIMARY_SOURCE}} | Precision or conflict resolution |
